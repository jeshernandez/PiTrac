...
namespace golf_sim {
    ...
    public:
        ...
        static cv::Mat UndistortImage(const cv::Mat& img, CameraHardware::CameraModel camera_model, CameraHardware::LensType lens_type, CameraHardware::CameraOrientation camera_orientation);
